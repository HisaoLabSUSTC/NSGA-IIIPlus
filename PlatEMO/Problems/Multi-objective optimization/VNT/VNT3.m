...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function R = GetOptimum(obj,N)
            X = UniformPoint(N*8,2,'grid')*6-3;
            R = obj.CalObj(X);
            R = R(NDSort(R,1)==1,:);
            aug = [0.0000000000000000, 17.0370370370370381, -0.1000000000000001;...
                1.5410774690819107, 15.0000000000000000, 0.1592548796507959;...
                0.0000000000000032, 17.0370368970974546, -0.1000000000000001];
            R=[R;aug];
        end
