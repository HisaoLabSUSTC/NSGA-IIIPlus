...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function R = GetOptimum(obj,N)
            % R = [];
            R = load("WFG3.mat").F;
            % % aug=[0,0,6;1,2,0;3,1,1];
            % v11 = [0,0,6];
            % v12 = [1,2,0];
            % v22 = [3,1,1];
            % e11 = linspace(v11(1),v12(1),100);
            % e12 = linspace(v11(2),v12(2),100);
            % e13 = linspace(v11(3),v12(3),100);
            % e1 = [e11',e12',e13'];
            % e21 = linspace(v12(1),v22(1),100);
            % e22 = linspace(v12(2),v22(2),100);
            % e23 = linspace(v12(3),v22(3),100);
            % e2 = [e21',e22',e23'];
            % R=[R;e1;e2];
        end
